"""Build v0.20 state with v0.19 iterative evidence as diagnostic prior."""
...
from .holdout_v17_benchmark import HOLDOUT_V17_ITEM_FINGERPRINTS, build_holdout_v17_harness
from .holdout_v18_benchmark import HOLDOUT_V18_ITEM_DOMAINS, HOLDOUT_V18_ROUTING_FINGERPRINTS
from .iterative_derivation_workflow import build_iterative_derivation_state
...
def build_staged_derivation_state(*, v19_report_path, **values):
    prior = build_iterative_derivation_state(**values)
    resolution = build_resolution_receipt_from_report(
        report_path=v19_report_path, harness=build_holdout_v17_harness(),
        item_fingerprints=HOLDOUT_V17_ITEM_FINGERPRINTS,
    ...
    acquisition = build_structural_operator_schedule(
        ...
        item_domains=HOLDOUT_V18_ITEM_DOMAINS, item_fingerprints=HOLDOUT_V18_ROUTING_FINGERPRINTS,
        budget=4,
    )
