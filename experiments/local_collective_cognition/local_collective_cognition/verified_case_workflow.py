"""Build v0.15 state with v0.14 outcomes retained as diagnostic evidence."""
...
from .case_adjudication_workflow import build_case_adjudication_state
...
from .holdout_v12_benchmark import HOLDOUT_V12_ITEM_FINGERPRINTS, build_holdout_v12_harness
from .holdout_v13_benchmark import HOLDOUT_V13_ITEM_DOMAINS, HOLDOUT_V13_ROUTING_FINGERPRINTS
...
def build_verified_case_state(
    *, base_profiles, calibration_cache: Path, pre_v08_sources,
    ...
    v14_report_path: Path,
):
    prior = build_case_adjudication_state(
    ...
    resolution = build_resolution_receipt_from_report(
        report_path=v14_report_path, harness=build_holdout_v12_harness(),
    ...
    sources = (*pre_v08_sources,
               ...
               (v14_report_path, build_holdout_v12_harness()))
    ...
    acquisition = build_structural_operator_schedule(
        ...
        item_domains=HOLDOUT_V13_ITEM_DOMAINS, item_fingerprints=HOLDOUT_V13_ROUTING_FINGERPRINTS,
        budget=4,
    )
