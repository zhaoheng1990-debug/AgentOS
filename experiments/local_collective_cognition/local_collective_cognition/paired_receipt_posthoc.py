"""Private-outcome audit for paired common-receipt v0.45."""
...
from .paired_receipt_experiment import RUNTIME_VERSION, SHARED_ARM_ID
from .paired_receipt_holdout import REPLICATION_IDS


POSTHOC_VERSION = "paired_receipt_posthoc_v0_45"


def analyze_paired_receipt_posthoc(*, corpus, run, analysis):
