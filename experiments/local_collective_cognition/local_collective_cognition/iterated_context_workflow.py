"""Build v0.13 state by promoting v0.12 context outcomes into a fresh cycle."""
...
from .context_resolution_workflow import build_context_receipt_from_report, build_context_resolution_state
...
from .holdout_v10_benchmark import HOLDOUT_V10_ITEM_FINGERPRINTS, build_holdout_v10_harness
from .holdout_v11_benchmark import HOLDOUT_V11_ITEM_DOMAINS, HOLDOUT_V11_ITEM_FINGERPRINTS
...
_RESOLVED_ACTIONS = ("PEER_AGREEMENT_RESOLVED", "PEER_OVERRIDE_RESOLVED", "PRIMARY_KEEP_RESOLVED")


def build_iterated_context_state(
    *, base_profiles: dict[str, CalibratedModelProfile], calibration_cache: Path,
    ...
    v11_report_path: Path, v12_report_path: Path,
) -> dict[str, Any]:
    prior = build_context_resolution_state(
    ...
    acquisition = build_structural_operator_schedule(
        ...
        item_domains=HOLDOUT_V11_ITEM_DOMAINS, item_fingerprints=HOLDOUT_V11_ITEM_FINGERPRINTS,
        budget=4,
    )
