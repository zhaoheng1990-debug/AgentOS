"""Private-outcome audit for portfolio displacement v0.50."""
...
from .portfolio_displacement_experiment import RUNTIME_VERSION, SHARED_ARM_ID
from .portfolio_displacement_holdout import REPLICATION_IDS


POSTHOC_VERSION = "portfolio_displacement_posthoc_v0_50"


def analyze_portfolio_displacement_posthoc(*, corpus, run, analysis):
    ...
    for key, gate in sorted(run["replacement_gate_receipts"].items()):
        ...
        cells.append({
            ...
            "opportunity_routing": copy.deepcopy(
                run["portfolio_displacement_receipts"][key]
            ),
