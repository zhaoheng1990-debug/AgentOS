"""Private-outcome audit for warrant-complete replication v0.49."""
...
from .warrant_complete_experiment import RUNTIME_VERSION, SHARED_ARM_ID
from .warrant_complete_holdout import REPLICATION_IDS


POSTHOC_VERSION = "warrant_complete_posthoc_v0_49"


def analyze_warrant_complete_posthoc(*, corpus, run, analysis):
    ...
    for key, gate in sorted(run["replacement_gate_receipts"].items()):
        ...
        cells.append({
            ...
            "opportunity_routing": copy.deepcopy(
                run["warrant_complete_receipts"][key]
            ),
