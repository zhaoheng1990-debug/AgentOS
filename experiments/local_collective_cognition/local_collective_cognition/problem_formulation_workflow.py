"""Build v0.24 state with v0.23 outcomes retained as diagnostic prior."""
...
from .holdout_v21_benchmark import HOLDOUT_V21_ITEM_FINGERPRINTS, build_holdout_v21_harness
from .holdout_v22_benchmark import HOLDOUT_V22_ITEM_DOMAINS, HOLDOUT_V22_ROUTING_FINGERPRINTS
from .multi_cycle_resolution import MultiCycleResolutionLifecycle
from .plan_intent_workflow import build_plan_intent_state
...
def build_problem_formulation_state(*, v23_report_path, **values):
    prior = build_plan_intent_state(**values)
    resolution = build_resolution_receipt_from_report(
        report_path=v23_report_path, harness=build_holdout_v21_harness(),
        item_fingerprints=HOLDOUT_V21_ITEM_FINGERPRINTS,
    ...
    resolution_candidates, resolution_promotions = _promote_all(
        resolution_lifecycle, resolution_receipts,
    )
    ...
    acquisition = build_structural_operator_schedule(
        ...
        item_fingerprints=HOLDOUT_V22_ROUTING_FINGERPRINTS, budget=4,
    )
    exploration = build_context_exploration_schedule(
        context_credit=context_credit, profiles=prior["profiles"],
        item_domains=HOLDOUT_V22_ITEM_DOMAINS,
        item_fingerprints=HOLDOUT_V22_ROUTING_FINGERPRINTS,
    ...
    return {**prior, "operator_schedule": {**acquisition, **exploration},
            ...
            "context_evidence_receipts": context_receipts,
