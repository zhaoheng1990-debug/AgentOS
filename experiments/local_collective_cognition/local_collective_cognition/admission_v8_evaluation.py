"""Four-arm pre-reference evaluation for boundary review v0.83."""
...
def build_pre_reference_evaluation(
    *,
    ...
    conditions.update({
        ...
        "grounded_boundary_mutation_policy": mutation_policy,
    ...
    value = {
        "evaluation_version": "admission_v8_pre_reference_v0_83",
