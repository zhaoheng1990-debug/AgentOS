"""Build v0.23 state with v0.22 plan-channel evidence as diagnostic prior."""
...
from .hierarchical_tool_workflow import build_hierarchical_tool_state
from .holdout_v20_benchmark import HOLDOUT_V20_ITEM_FINGERPRINTS, build_holdout_v20_harness
from .holdout_v21_benchmark import HOLDOUT_V21_ITEM_DOMAINS, HOLDOUT_V21_ROUTING_FINGERPRINTS
...
def build_plan_intent_state(*, v22_report_path, **values):
    prior = build_hierarchical_tool_state(**values)
    resolution = build_resolution_receipt_from_report(
        report_path=v22_report_path, harness=build_holdout_v20_harness(),
        item_fingerprints=HOLDOUT_V20_ITEM_FINGERPRINTS,
    ...
    acquisition = build_structural_operator_schedule(
        ...
        item_domains=HOLDOUT_V21_ITEM_DOMAINS,
        item_fingerprints=HOLDOUT_V21_ROUTING_FINGERPRINTS, budget=4,
    )
    exploration = build_context_exploration_schedule(
        context_credit=context_credit, profiles=prior["profiles"],
        item_domains=HOLDOUT_V21_ITEM_DOMAINS,
        item_fingerprints=HOLDOUT_V21_ROUTING_FINGERPRINTS,
