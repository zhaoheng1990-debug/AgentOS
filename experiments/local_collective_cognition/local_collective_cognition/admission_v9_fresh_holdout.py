"""Seventh unused-source holdout for ternary boundary review v0.84."""
...
from .admission_v8_fresh_holdout import (
    SELECTED_PROMPT_IDS as V083_PROMPT_IDS,
    prior_surface_ids as v083_prior_surface_ids,
)
...
SOURCE_FILES = (
    ...
    "admission_v9_compiler.py",
    "admission_v9_contracts.py",
    "admission_v9_facts.py",
    "admission_v9_runtime.py",
    "admission_v9_schemas.py",
    "admission_v9_tasks.py",
)


def prior_surface_ids():
    return v083_prior_surface_ids() | set(V083_PROMPT_IDS)
...
def build_fresh_holdout(paths, *, source_manifest):
    panel = build_selected_panel(
        ...
        benchmark_id="evidence-inference-admission-v9-fresh-holdout",
        split="seventh_unused_test_selection_v0_84",
    ...
    value.update({
        "bridge_version": "admission_v9_fresh_holdout_v0_84",
        "selection_version": "sha256_seventh_unused_test_objects_v0_84",
...
def validate_fresh_holdout(panel):
    ...
    if (
        ...
        raise ValueError("admission_v9_fresh_holdout_invalid")


def build_preregistration(panel):
    validate_fresh_holdout(panel)
    value = {
        "preregistration_version": "admission_v9_fresh_holdout_v0_84",
