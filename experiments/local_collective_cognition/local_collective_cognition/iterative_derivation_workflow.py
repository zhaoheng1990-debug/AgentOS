"""Build v0.19 state with v0.18 typed-plan evidence as diagnostic prior."""
...
from .holdout_v16_benchmark import HOLDOUT_V16_ITEM_FINGERPRINTS, build_holdout_v16_harness
from .holdout_v17_benchmark import HOLDOUT_V17_ITEM_DOMAINS, HOLDOUT_V17_ROUTING_FINGERPRINTS
...
from .typed_derivation_workflow import build_typed_derivation_state
...
def build_iterative_derivation_state(*, v18_report_path, **values):
    prior = build_typed_derivation_state(**values)
    resolution = build_resolution_receipt_from_report(
        report_path=v18_report_path, harness=build_holdout_v16_harness(),
        item_fingerprints=HOLDOUT_V16_ITEM_FINGERPRINTS,
    ...
    acquisition = build_structural_operator_schedule(
        ...
        item_domains=HOLDOUT_V17_ITEM_DOMAINS, item_fingerprints=HOLDOUT_V17_ROUTING_FINGERPRINTS,
        budget=4,
    )
