"""Build v0.18 state with v0.17 candidate-revision evidence as a diagnostic prior."""

from __future__ import annotations

from .calibrated_resolution_workflow import build_resolution_receipt_from_report
from .candidate_revision_workflow import build_candidate_revision_state
...
from .holdout_v15_benchmark import HOLDOUT_V15_ITEM_FINGERPRINTS, build_holdout_v15_harness
from .holdout_v16_benchmark import HOLDOUT_V16_ITEM_DOMAINS, HOLDOUT_V16_ROUTING_FINGERPRINTS
...
def build_typed_derivation_state(*, v17_report_path, **values):
    prior = build_candidate_revision_state(**values)
    resolution = build_resolution_receipt_from_report(
        report_path=v17_report_path, harness=build_holdout_v15_harness(),
        item_fingerprints=HOLDOUT_V15_ITEM_FINGERPRINTS,
    ...
    acquisition = build_structural_operator_schedule(
        ...
        item_domains=HOLDOUT_V16_ITEM_DOMAINS, item_fingerprints=HOLDOUT_V16_ROUTING_FINGERPRINTS,
        budget=4,
    )
