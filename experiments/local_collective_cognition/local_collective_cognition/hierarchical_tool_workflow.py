"""Build v0.22 state with v0.21 constrained-tool evidence as diagnostic prior."""

from __future__ import annotations

from .calibrated_resolution_workflow import build_resolution_receipt_from_report
from .constrained_tool_workflow import build_constrained_tool_state
...
from .holdout_v19_benchmark import HOLDOUT_V19_ITEM_FINGERPRINTS, build_holdout_v19_harness
from .holdout_v20_benchmark import HOLDOUT_V20_ITEM_DOMAINS, HOLDOUT_V20_ROUTING_FINGERPRINTS
...
def build_hierarchical_tool_state(*, v21_report_path, **values):
    prior = build_constrained_tool_state(**values)
    resolution = build_resolution_receipt_from_report(
        report_path=v21_report_path, harness=build_holdout_v19_harness(),
        item_fingerprints=HOLDOUT_V19_ITEM_FINGERPRINTS,
    ...
    acquisition = build_structural_operator_schedule(
        ...
        item_domains=HOLDOUT_V20_ITEM_DOMAINS,
        item_fingerprints=HOLDOUT_V20_ROUTING_FINGERPRINTS, budget=4,
    )
