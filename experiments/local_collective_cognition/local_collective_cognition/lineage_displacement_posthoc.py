"""Private-outcome audit for lineage-bound displacement v0.47."""
...
from .lineage_displacement_experiment import RUNTIME_VERSION, SHARED_ARM_ID
from .lineage_displacement_holdout import REPLICATION_IDS


POSTHOC_VERSION = "lineage_displacement_posthoc_v0_47"


def analyze_lineage_displacement_posthoc(*, corpus, run, analysis):
    ...
    for key, gate in sorted(run["replacement_gate_receipts"].items()):
        ...
        cells.append({
            ...
            "opportunity_routing": copy.deepcopy(
                run["lineage_displacement_receipts"][key]
            ),
