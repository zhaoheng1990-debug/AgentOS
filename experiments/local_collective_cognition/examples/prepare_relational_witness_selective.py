"""Freeze the v0.23 relational-witness preregistration and holdout."""
...
def main():
    ...
    source = read(
        REPO_ROOT
        / "outputs"
        / "evidence_first_selective_v0_22"
        / "external_panel"
        / "evidence_first_external_evaluation.json"
    )
    ...
    write(output / "relational_witness_corpus_frozen.json", corpus)
    print(json.dumps({
