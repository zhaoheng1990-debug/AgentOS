"""Close and package a v0.40 mathematically infeasible contract run."""
...
def main():
    ...
    progress = read(output / "null_role_progress.json")
    progress_commitment = {
    ...
    contract_failures = [
        ...
        if value["stage"] == "STANDARD_NULL_ROLE_CONTRACT"
    ]
    ...
    analysis_commitment = {
        "analysis_version": "null_role_early_stop_v0_40",
        ...
        "candidate_state": "NULL_ROLE_CONTRACT_STOP",
    ...
    write(output / "null_role_early_stop_analysis.json", analysis)
    report = "\n".join([
        ...
        "",
        "Decision: `STOP_CONTRACT_INFEASIBLE`.",
        "Candidate state: `NULL_ROLE_CONTRACT_STOP`.",
    ])
    (output / "experiment_report.md").write_text(
        report, encoding="utf-8"
    )
    ledger_commitment = {
        "ledger_version": "null_role_early_stop_ledger_v0_40",
        "source_progress_hash": progress["artifact_hash"],
    ...
    names = [
        ...
        "null_role_early_stop_analysis.json",
