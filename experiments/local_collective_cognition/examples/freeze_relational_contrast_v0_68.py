"""Freeze v0.68 against the existing calibration and untouched holdout."""
...
def main() -> int:
    source = REPO_ROOT / "outputs" / "comparison_frame_v0_67"
    ...
    prereg = build_calibration_preregistration(
