"""Write v0.48 private-outcome review-ready audit."""
...
from local_collective_cognition.review_ready_posthoc import (  # noqa: E402
    analyze_review_ready_posthoc,
)
...
def main():
    ...
    posthoc = analyze_review_ready_posthoc(
    ...
    write(output / "posthoc_review_ready.json", posthoc)
    print(json.dumps({
