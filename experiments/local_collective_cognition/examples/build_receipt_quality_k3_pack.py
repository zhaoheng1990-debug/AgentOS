"""Validate GPT/Gemini receipt-quality responses and build the K3 dispute pack."""
...
def main():
    ...
    _write(output / "gpt_5_6_receipt_quality_response.json", responses[0])
    _write(output / "gemini_3_1_receipt_quality_response.json", responses[1])
    _write(output / "kimi_k3_receipt_quality_adjudication_pack.json", pack)
