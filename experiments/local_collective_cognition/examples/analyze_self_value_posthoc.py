"""Write v0.38 private-outcome self-value calibration audit."""
...
from local_collective_cognition.self_value_posthoc import (  # noqa: E402
    analyze_self_value_posthoc,
)
...
def main():
    ...
    posthoc = analyze_self_value_posthoc(
    ...
    write(output / "posthoc_self_value_calibration.json", posthoc)
    print(json.dumps({
