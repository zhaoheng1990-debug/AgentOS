"""Validate v0.2 panel responses and build the blind K3 dispute pack."""
...
def main():
    ...
    _write(output / "gpt_5_6_negative_generalization_response.json", responses[0])
    _write(output / "gemini_3_1_negative_generalization_response.json", responses[1])
    pack_path = output / "kimi_k3_negative_generalization_adjudication_pack.json"
