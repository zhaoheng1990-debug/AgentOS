"""Freeze, run, and score v0.74 grouped-object aliases."""
...
from local_collective_cognition.grouped_alias_surface_protocol import (  # noqa: E402
...
def main():
    ...
    source = ROOT / "outputs" / "prospective_surface_v0_73"
    ...
    score = {
        "score_version": "grouped_alias_surface_score_v0_74",
        "baseline": baseline,
        "candidate": candidate,
    ...
    decision = {
        "decision_version": "grouped_alias_surface_decision_v0_74",
        ...
        "decision": (
            ...
            if passed
            else "REJECT_GROUPED_ALIAS_SURFACE_CALIBRATION"
        ),
