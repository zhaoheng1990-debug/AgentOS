"""Validate v0.82 lane responses and build anonymous Kimi pack."""
...
def main():
    ...
    packs = (
        read(output / "gpt_5_6_staged_context_admission_pack_v0_82.json"),
        read(output / "gemini_3_1_staged_context_admission_pack_v0_82.json"),
    )
    responses = (
    ...
    pack_path = output / "kimi_k3_staged_context_pack_v0_82.json"
    ...
    zip_path = output / "Kimi_K3_Staged_Context_Adjudication_v0_82.zip"
