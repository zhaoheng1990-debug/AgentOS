"""Validate v0.84 lane responses and build anonymous Kimi pack."""
...
def main():
    ...
    packs = (
        read(output / "gpt_5_6_ternary_boundary_admission_pack_v0_84.json"),
        read(output / "gemini_3_1_ternary_boundary_admission_pack_v0_84.json"),
    )
    responses = (
    ...
    pack_path = output / "kimi_k3_ternary_boundary_pack_v0_84.json"
    ...
    zip_path = output / "Kimi_K3_Ternary_Boundary_Adjudication_v0_84.zip"
