"""Freeze and run minimal witness admission v0.79."""
...
from local_collective_cognition.admission_v4_evaluation import (  # noqa: E402
    build_pre_reference_evaluation,
)
from local_collective_cognition.admission_v4_fresh_holdout import (  # noqa: E402
    build_fresh_holdout,
...
from local_collective_cognition.admission_v4_runtime import (  # noqa: E402
    run_minimal_witness_panel,
)
...
def main():
    ...
    output = ROOT / "outputs" / "admission_v4_fresh_holdout_v0_79"
