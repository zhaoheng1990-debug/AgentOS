"""Freeze and run staged context utility admission v0.82."""
...
from local_collective_cognition.admission_v7_evaluation import (  # noqa: E402
    build_pre_reference_evaluation,
)
from local_collective_cognition.admission_v7_fresh_holdout import (  # noqa: E402
    build_fresh_holdout,
...
def main():
    ...
    parser.add_argument(
        "--stage",
        required=True,
        choices=("freeze", "baseline", "atomic", "candidate", "score"),
    )
    stage = parser.parse_args().stage
    output = ROOT / "outputs" / "admission_v7_fresh_holdout_v0_82"
    ...
    print(json.dumps({
        ...
        "invalid_evidence_change_count": (
            evaluation["invalid_evidence_change_count"]
        ),
