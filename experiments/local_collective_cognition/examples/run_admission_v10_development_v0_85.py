"""Freeze and run the v0.85 study-relation development screen."""
...
from local_collective_cognition.admission_v10_development_holdout import (  # noqa: E402
    build_development_holdout,
    build_preregistration,
    public_development_holdout,
    validate_development_holdout,
    validate_preregistration,
)
from local_collective_cognition.admission_v10_evaluation import (  # noqa: E402
    build_development_evaluation,
)
from local_collective_cognition.admission_v10_runtime import (  # noqa: E402
    run_study_relation_review_panel,
)
...
def main():
    ...
    if stage == "freeze":
        ...
        write(
            ...
            public_development_holdout(panel),
        )
        ...
        print(json.dumps({
            ...
            "source_split_role": panel["source_split_role"],
    ...
    if stage == "staged":
        ...
        return
    if stage == "candidate":
        run = run_study_relation_review_panel(
            panel=panel,
            preregistration=preregistration,
        ...
        print(json.dumps(_run_summary(run), indent=2))
        return
    evaluation = build_development_evaluation(
        panel=panel,
        preregistration=preregistration,
    ...
    write(output / "development_evaluation.json", evaluation)
    print(json.dumps({
        ...
        "relation_mutation_count": evaluation["relation_mutation_count"],
        "relation_mutation_counts": evaluation["relation_mutation_counts"],
