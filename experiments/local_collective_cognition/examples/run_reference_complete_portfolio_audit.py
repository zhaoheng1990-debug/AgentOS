"""Run the v0.51 dual-role reference completeness audit."""
...
def main():
    ...
    corpus = read(
        output / "reference_complete_portfolio_corpus_frozen.json"
    )
    adapter = BoundedRetryProviderAdapter(
        OpenAICompatibleJsonAdapter(OpenAICompatibleProviderSpec(
            provider_id="deepseek-reference-audit-v0-51",
    ...
    print(json.dumps({
        ...
        "state_distribution": audit["state_distribution"],
