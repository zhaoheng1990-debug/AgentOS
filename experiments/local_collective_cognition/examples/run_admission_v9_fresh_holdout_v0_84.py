"""Freeze and run ternary boundary review admission v0.84."""
...
from local_collective_cognition.admission_v9_evaluation import (  # noqa: E402
    build_pre_reference_evaluation,
)
from local_collective_cognition.admission_v9_fresh_holdout import (  # noqa: E402
    build_fresh_holdout,
...
from local_collective_cognition.admission_v9_runtime import (  # noqa: E402
    run_ternary_boundary_review_panel,
)
...
def main():
    ...
    if stage == "staged":
        ...
        return
    if stage == "candidate":
        run = run_ternary_boundary_review_panel(
            panel=panel,
            preregistration=preregistration,
