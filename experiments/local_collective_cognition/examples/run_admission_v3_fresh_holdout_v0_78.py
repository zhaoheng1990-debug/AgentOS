"""Freeze and run the witness admission v0.78 fresh holdout."""
...
from local_collective_cognition.admission_v3_evaluation import (  # noqa: E402
    build_pre_reference_evaluation,
)
from local_collective_cognition.admission_v3_fresh_holdout import (  # noqa: E402
    build_fresh_holdout,
...
from local_collective_cognition.admission_v3_runtime import (  # noqa: E402
    run_witness_admission_panel,
)
...
def main():
    ...
    output = ROOT / "outputs" / "admission_v3_fresh_holdout_v0_78"
    ...
    if stage == "baseline":
        ...
        return
    if stage == "candidate":
        run = run_witness_admission_panel(
            panel=panel,
            preregistration=preregistration,
            adapter=build_deepseek_adapter(),
        )
