"""Write v0.41 private-outcome selective-delta audit."""
...
from local_collective_cognition.selective_delta_posthoc import (  # noqa: E402
    analyze_selective_delta_posthoc,
)
...
def main():
    ...
    posthoc = analyze_selective_delta_posthoc(
    ...
    write(output / "posthoc_selective_delta_calibration.json", posthoc)
    print(json.dumps({
