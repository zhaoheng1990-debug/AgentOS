from local_collective_cognition.admission_v9_fresh_holdout import (
    SELECTED_PROMPT_IDS,
    build_fresh_holdout,
...
def test_v084_selected_objects_are_disjoint_from_prior_surfaces():
    assert not set(SELECTED_PROMPT_IDS) & prior_surface_ids()


def test_v084_preregisters_ternary_boundary_authority():
    ...
    assert gate["not_stated_demotion_allowed"] is False
