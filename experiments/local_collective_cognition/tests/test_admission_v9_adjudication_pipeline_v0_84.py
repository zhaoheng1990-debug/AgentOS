...
from local_collective_cognition.admission_v9_external_adjudication import (
    build_adjudication,
...
def test_v084_synthetic_disagreement_closes_reference_pipeline():
    packs = (
        read(
            EXTERNAL
    ...
    assert pack["staged_system_outputs"] == "WITHHELD"
