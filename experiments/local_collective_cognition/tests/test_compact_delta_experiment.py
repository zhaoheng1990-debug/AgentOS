...
from local_collective_cognition.compact_delta_experiment import (  # noqa: E402
    analyze_compact_delta_experiment,
    build_compact_delta_preregistration,
    run_compact_delta_experiment,
)
from local_collective_cognition.compact_delta_holdout import (  # noqa: E402
    build_compact_delta_holdout,
...
def _prior():
    analysis_value = {
        ...
        "candidate_state": "SELECTIVE_DELTA_REJECTED_STOP",
        "physical_total_tokens": 209319,
        "runtime_metrics": {
            "standard_selective_delta_contract_coverage": 1.0,
            "counter_selective_delta_contract_coverage": 0.666667,
        },
        "composition_metrics": {
            "triggered_composition_gross_uplift": {"mean": 1.625},
            "mean_delta_token_penalty_cbit": 0.718,
        },
    }
    closure_value = {
        "candidate_state": "SELECTIVE_DELTA_REJECTED_STOP"
    ...
    posthoc_value = {
        ...
        "invalid_delta_contract_count": 2,
    }
    return tuple({
        **value,
...
def test_compact_delta_contract_and_source_calibrated_composition():
    corpus = build_compact_delta_holdout()
...
def test_compact_delta_experiment_can_pass_fixture():
    ...
    assert analysis["compact_delta_gate"] == "PASS"
    ...
    assert all(
        len(value["candidate_diagnostics"]) == 4
