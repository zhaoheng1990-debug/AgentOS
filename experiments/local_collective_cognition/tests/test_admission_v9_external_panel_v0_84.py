...
from local_collective_cognition.admission_v9_external_panel import (
...
def test_v084_external_panel_is_complete_blinded_and_deterministic():
    inputs = {
    ...
    assert all(
        ...
        and pack["staged_system_outputs"] == "WITHHELD"
