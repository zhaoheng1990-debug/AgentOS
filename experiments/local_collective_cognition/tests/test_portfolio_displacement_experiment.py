...
from local_collective_cognition.portfolio_displacement_experiment import (  # noqa: E402
    ...
    build_portfolio_displacement_preregistration,
    run_portfolio_displacement_experiment,
)
from local_collective_cognition.portfolio_displacement_holdout import (  # noqa: E402
    build_portfolio_displacement_holdout,
...
from local_collective_cognition.portfolio_displacement_contract import (  # noqa: E402
    ...
    values = (
        {
            ...
            "candidate_state": "WARRANT_COMPLETE_REJECTED_STOP",
            "physical_total_tokens": 170496,
            "runtime_metrics": {
        ...
        {"candidate_state": "WARRANT_COMPLETE_REJECTED_STOP"},
        {
            ...
            "mean_fraction_of_positive_oracle_uplift_captured": 0.166667,
            "positive_oracle_cell_count": 6,
...
def test_portfolio_displacement_contract_rejects_semantic_drift():
    corpus = build_portfolio_displacement_holdout()
...
def test_portfolio_displacement_fixture_closes_end_to_end():
    corpus = build_portfolio_displacement_holdout()
    validate_portfolio_displacement_holdout(corpus)
    analysis0, closure0, posthoc0 = _prior()
    preregistration = build_portfolio_displacement_preregistration(
        corpus=corpus,
    ...
    assert validate_portfolio_displacement(
        receipt=portfolio_receipt,
        item=portfolio_view,
        refs=corpus["evidence_refs"],
    ) == []
    schema = portfolio_displacement_schema(
    ...
    assert analysis["portfolio_displacement_gate"] == "PASS"
