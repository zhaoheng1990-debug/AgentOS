...
from local_collective_cognition.review_ready_lineage_contract import (  # noqa: E402
    build_review_ready_delta_view,
    review_ready_delta_schema,
    validate_review_ready_delta,
)
from local_collective_cognition.review_ready_experiment import (  # noqa: E402
    analyze_review_ready_experiment,
    build_review_ready_preregistration,
    run_review_ready_experiment,
)
from local_collective_cognition.review_ready_holdout import (  # noqa: E402
    build_review_ready_holdout,
    ...
    values = (
        {
            ...
            "candidate_state": "LINEAGE_DISPLACEMENT_REJECTED_STOP",
            "physical_total_tokens": 115921,
            "runtime_metrics": {
                "standard_compact_delta_contract_coverage": 1.0,
                "counter_compact_delta_contract_coverage": 0.0,
            },
            "composition_metrics": {
                "triggered_composition_gross_uplift": None,
            },
            "replacement_gate_metrics": {"accepted_count": 0},
        },
        {"candidate_state": "LINEAGE_DISPLACEMENT_REJECTED_STOP"},
        {
            "formal_decision_unchanged": True,
            "mean_fraction_of_positive_oracle_uplift_captured": 0.0,
            "positive_oracle_cell_count": 0,
...
def test_review_ready_contract_rejects_semantic_drift():
    corpus = build_review_ready_holdout()
    ...
    view = build_review_ready_delta_view(
        raw_receipt=base,
        item=item,
    ...
    assert (
        "REVIEW_LINEAGE_SEMANTIC_AXIS_DRIFT:"
        "research_value_disposition"
    ) in validate_review_ready_delta(
        delta=strengthened,
        item=view,
    ...
    assert (
        "REVIEW_LINEAGE_SOURCE_OPPORTUNITY_RESEARCH_VALUE_"
...
def test_review_ready_fixture_closes_end_to_end():
    ...
    assert analysis["review_ready_gate"] == "PASS"
