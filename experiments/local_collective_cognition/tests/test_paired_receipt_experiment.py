...
from local_collective_cognition.paired_receipt_experiment import (  # noqa: E402
    analyze_paired_receipt_experiment,
    build_paired_receipt_preregistration,
    run_paired_receipt_experiment,
)
from local_collective_cognition.paired_receipt_holdout import (  # noqa: E402
    build_paired_receipt_holdout,
...
def _prior():
    analysis_value = {
        ...
        "candidate_state": "TRI_LANE_REJECTED_STOP",
        "physical_total_tokens": 221335,
        "runtime_metrics": {
        ...
        "composition_metrics": {
            ...
            "mean_delta_token_penalty_cbit": 0.641688,
        },
    ...
    posthoc_value = {
        ...
        "mean_fraction_of_positive_oracle_uplift_captured": 0.438596,
        "positive_oracle_cell_count": 9,
...
def test_compact_delta_contract_and_source_calibrated_composition():
    corpus = build_paired_receipt_holdout()
...
def test_paired_receipt_experiment_can_pass_fixture():
    ...
    assert analysis["paired_receipt_gate"] == "PASS"
